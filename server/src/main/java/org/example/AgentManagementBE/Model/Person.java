...
public class Person {
    ...
    public String getPersonSDT() { return personSDT; }
    public void setPersonSDT(String personSDT) { this.personSDT = personSDT; }
    ...
    public void setPersonPassword(String personPassword) { this.personPassword = personPassword; }
}
