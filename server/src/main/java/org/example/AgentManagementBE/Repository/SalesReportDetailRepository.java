...
public interface SalesReportDetailRepository extends CrudRepository<SalesReportDetail, SalesReportDetailID> {
    ...
    @Query("SELECT salesReportDetail FROM SalesReportDetail salesReportDetail WHERE salesReportDetail.agentID = :agentID AND salesReportDetail.salesReportID = :salesReportID")
