...
public class DistrictController {
    ...
    public ResponseEntity<Map<String, Object>> updateDistrict(@RequestBody District district) {
        return districtService.updateDistrict(district.getDistrictName(), district);
    }
